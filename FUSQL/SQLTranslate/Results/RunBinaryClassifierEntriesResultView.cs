...
{
    public class RunBinaryClassifierEntriesResultView<TRowModel> : ResultView<TRowModel> where TRowModel : class, new()
    {
        public Dictionary<string, List<TRowModel>> Predictions { get; set; } = new Dictionary<string, List<TRowModel>>();
        public RunBinaryClassifierEntriesResultView() : base(DataMinner.Mining.Enums.MiningOp.ClassifyEntries) { }
